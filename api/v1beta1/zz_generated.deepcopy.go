...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PersistentMount) DeepCopyInto(out *PersistentMount) {
	*out = *in
	if in.BootstrapFromImage != nil {
		in, out := &in.BootstrapFromImage, &out.BootstrapFromImage
		*out = new(bool)
		**out = **in
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PersistentMount.
func (in *PersistentMount) DeepCopy() *PersistentMount {
	if in == nil {
		return nil
	}
	out := new(PersistentMount)
	in.DeepCopyInto(out)
	return out
}
...
func (in *PersistentStorageSpec) DeepCopyInto(out *PersistentStorageSpec) {
	*out = *in
	...
	if in.Mounts != nil {
		...
		*out = make([]PersistentMount, len(*in))
		for i := range *in {
